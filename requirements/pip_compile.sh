...
# for requirements
python -m piptools compile --upgrade requirements/requirements.in -o requirements/requirements.txt
# python3 -m piptools compile --upgrade requirements/requirements.in -o requirements/requirements.txt

# for requirements-dev
python -m piptools compile --upgrade requirements/requirements-dev.in -o requirements/requirements-dev.txt
